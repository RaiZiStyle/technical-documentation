...
#define NUMBER_DATA_IN_FLASH (11)  // 2 ratio&sign
#define FLOAT_PRECISION      3
#define FLOAT_MAX_LEN        (FLOAT_PRECISION + 4)  // "xx." Aka, 3.
#define FLOAT_STRING_MAX_LEN (FLOAT_MAX_LEN + 1)    // '\0'

#define STRING_MAX_LEN_IN_FLASH                                                                                        \
    ((FLOAT_STRING_MAX_LEN) > (SERIAL_NUMBER_LEN) ? (FLOAT_STRING_MAX_LEN) : (SERIAL_NUMBER_LEN))
